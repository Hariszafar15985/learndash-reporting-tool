...
/**
 * Elementor widget that control group reporting
 *
 * @since 1.0.0
 */
if (!defined('ABSPATH'))
...
global $aloa_options;
class Elementor_Aloa_Reporting_Group extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'aloa_reporting_group';
    }

    public function get_title()
    {
        return esc_html__('Aloa Group Report', 'aloa-agency-learndash-reporting-tool');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__('Content', 'aloa-agency-learndash-reporting-tool'),
    ...
    protected function render()
    {
        ...
        $provelopers_settings = $this->get_settings_for_display();
        ...
        $std_sort = isset($_GET['sort']) && !empty($_GET['sort']) ? $_GET['sort'] : 'desc';
...
?>
        <div class="famb-hub-wrap">
                ...
                <div class="famb-hub-content">
                    <div class="famb-hub-header">
                        <div class="famb-group-name">
                            <h1><?php echo $group_id != '' ? get_the_title($course_id) : ''; ?></h1>
                        </div>
                    ...
                    <div class="aloa-std-progress-wrap" style="display:<?php echo isset($student_data['progress_data']) && !empty($student_data['progress_data']) ? 'block' : 'none'; ?>">
                        <?php
                        if (isset($student_data['progress_data']) && $student_data['progress_data'] != '' && $group_id != '') {
                    ...
                    <div class="famb-main-wrap">
                        ...
                        <div class="famb-hub-course">
                            <div class="famb-course-head">
                                <!-- <h3 class="aloa-head-course"><?php //echo $course_id != '' ? get_the_title($course_id) : ''; 
                                                                    ?></h3> -->
                                <h5 class="aloa-head-group"><?php echo $group_id != '' ? get_the_title($group_id) . ' Student List' : ''; ?></h5>
                            </div>
                        ...
                        <div class="famb-group-std-data">
                            ...
                            if (isset($student_data['student_data']) && $student_data['student_data'] != '') {
                                echo aloa_students_record_table_data($student_data['student_data'], $per_page, $current_page, $std_sort);
                            } else {
                                echo aloa_students_record_table_data('', $per_page, $current_page, $std_sort);
                            }
                            ?>
                        </div>
                    </div>
            ...
            <?php } else {
                echo '<p style="padding:20px;">You must be loggedin to access this page.</p>';
            } ?>
        </div>
...
<?php
        $content_shortco = ob_get_clean();
        echo $content_shortco;
    }
}
