...
?>
        <div class="famb-hub-wrap">
            <div class="famb-hub-sidebar">
                <ul id="menu">
                    <li>
                        <a href="https://fambizstg.wpengine.com/toolkit/"><i aria-hidden="true" class="fas fa-toolbox"></i><?php echo __('Toolkit', 'aloa-agency-learndash-reporting-tool'); ?></a>
                    </li>
                    <?php
                    if (isset($group_list) && !empty($group_list)) {
                    ?>
                        <li id="aloa-teacher-groups">
                            <a href="javascript:void(0)" class="aloa-group-toggle">
                                <i aria-hidden="true" class="fas fa-user-friends"></i>
                                <?php echo __('My Groups', 'aloa-agency-learndash-reporting-tool'); ?>
                                <span class="arrow"><i aria-hidden="true" class="fas fa-chevron-down"></i></span>
            ...
            ?>
                <li id="aloa-teacher-groups">
                    ...
                    <ul style="display:<?php echo isset($group_id) && $group_id != '' ? 'block' : 'none'; ?>">
                        <li class=""><img decoding="async" src="<?php echo ALOA_REPORTING_PLUGIN_URL;?>/assets/images/groupLi2.png"><a href="<?php echo esc_url(get_the_permalink($new_group_page)); ?>">Add new group</a></li>
                    </ul>
                </li>
            <?php
                    }
            ?>
            <li><a href="https://fambizstg.wpengine.com/toolkit/"><i aria-hidden="true" class="fas fa-folder"></i><?php echo __('Fambiz', 'aloa-agency-learndash-reporting-tool'); ?></a></li>
            </ul>
            </div>
            <div class="famb-hub-content">
                ...
                <div class="aloa-std-progress-wrap" style="display:<?php echo isset($student_data['progress_data']) && $student_data['progress_data'] != '' ? 'block' : 'none'; ?>">
                    ...
                    if (isset($student_data['progress_data']) && $student_data['progress_data'] != '') {
                        echo aloa_student_progress_data($student_data['progress_data']);
                    }
                    ?>
                </div>
